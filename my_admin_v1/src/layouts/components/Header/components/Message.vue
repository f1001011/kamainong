<template>
  <div class="message">
    <el-popover placement="bottom" :width="310" trigger="click">
      <template #reference>
        <el-badge :value="showDemoNotifications ? 5 : 0" class="item">
          <i :class="'iconfont icon-xiaoxi'" class="toolBar-icon"></i>
        </el-badge>
      </template>
      <el-tabs v-model="activeName">
        <!--消息通知-->
        <el-tab-pane :label="`通知(${showDemoNotifications ? 5 : 0})`" name="first">
          <template v-if="showDemoNotifications">
...
const showDemoNotifications = false;
</script>
