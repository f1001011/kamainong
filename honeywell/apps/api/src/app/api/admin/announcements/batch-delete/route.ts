...
import { batchDeleteAnnouncement } from '@/services/content-management.service';
...
// ================================
// POST /api/admin/announcements/batch-delete - 批量删除公告
// ================================
export async function POST(request: NextRequest) {
  return withAdminAuth(request, async (req, _adminId) => {
    try {
      ...
      console.error('[公告批量删除] 删除失败:', error);
      return errorResponse('SYSTEM_ERROR', '批量删除公告失败', 500);
    }
  });
}
