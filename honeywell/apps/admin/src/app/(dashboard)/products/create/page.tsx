/**
 * @file 产品新增页
 * @description 创建新产品，支持实时预览、图片上传、富文本编辑
  ...
  const handleSubmit = useCallback(
    async (isDraft = false) => {
      try {
        ...
        message.success(isDraft ? '已保存为草稿' : '产品创建成功');
    ...
    [form, mainImageUrl, detailImageList, message, router]
  );
    ...
    <div style={{ padding: 24, maxWidth: 1600 }}>
      ...
      >
        <div>
          ...
          <Text type="secondary">创建新的产品，设置价格、收益和展示信息</Text>
        </div>
        <Space>
          <Button
      ...
      <Alert
        ...
        description={
          <ul style={{ margin: 0, paddingLeft: 20 }}>
            <li>产品编码创建后建议不要修改，以免影响关联数据</li>
            <li>体验产品(TRIAL)不触发用户首购返佣，付费产品(PAID)触发</li>
            <li>总收益由系统自动计算，= 日收益 × 周期天数</li>
            <li>VIP等级配置说明：Po系列赠送VIP等级，VIP系列赠送SVIP等级</li>
          </ul>
        }
              ...
              <Row gutter={16}>
                <Col xs={24} md={12}>
                  <Form.Item
                    ...
                    valuePropName="checked"
                    extra="仅体验产品(TRIAL)有效，开启后产品卡片显示「新手推荐」角标"
                  >
